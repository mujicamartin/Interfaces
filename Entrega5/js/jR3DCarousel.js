	...
	$.fn.jR3DCarousel = function(options){
		...
		(function setup(){
			...
			function _createNavigation(){
				...
				_navigation.find('.nav').css({ display: 'inline-block', margin: '5px', cursor: 'pointer', backgroundColor: 'rgba(255, 255, 255, 0.77)', width: '30px', height: '8px', transition: 'all '+_settings.animationDuration+'ms ease' })
